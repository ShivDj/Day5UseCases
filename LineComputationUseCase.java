...
public class LineComputationUseCase 
{

	public static void main(String[] args) 
	{
	    System.out.println("Wellcome to LineComputation Programm Here we Calculate Distance Between Two Point Please Select choice to perform operations");	
	    Scanner sc=new Scanner(System.in);
	    System.out.println("Enter the choice=");
	    System.out.println("Enter 1 to calculate the lenght=");
	    System.out.println("Enter 2 To check the equality of two line=");
	    ...
	    default:System.out.println("You have Enter the wrong choice");
	            break;
	    }
